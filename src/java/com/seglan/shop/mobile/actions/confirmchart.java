 ...
 * @author igaraizabal
 */
public class confirmchart extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        com.seglan.shop.mobile.forms.confirmchart frm = (com.seglan.shop.mobile.forms.confirmchart) form;
        String usId = frm.getIduser();
        String evtId = frm.getEvtid();
        JsonResponse resp = new JsonResponse();
        
        if(DBM.confirmChart(usId,evtId)) {
            resp.status = "OK";
            resp.data = "Confirmed";
        }
        else
