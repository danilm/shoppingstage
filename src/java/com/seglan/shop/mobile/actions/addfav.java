 ...
 */
public class addfav extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        com.seglan.shop.mobile.forms.addfav frm = (com.seglan.shop.mobile.forms.addfav) form;
        String iduser = frm.getIduser();
        String idprod = frm.getIdprod();
        String idevt = frm.getIdevt();
        String fav = frm.getFav();
       

        Connection conn = common.getConnection();
        DataMethods DBM = new DataMethods(conn);
        int result = DBM.addFav(iduser,idevt, idprod, fav);
